...
<head>
  ...
  <title>D3Vtools Live Worker</title>
  ...
  <div class="shell">
    <header class="hero">
      <div class="hero-copy">
        ...
        <h1>D3Vtools</h1>
        <p class="sub">
          Load a page in a live same-origin iframe, inspect the response source before dynamic rendering, and keep HTML, CSS, JS, and live DOM snapshots separated.
        </p>
      </div>
