...
<body>
  <div class="wrap">
    ...
    <div class="preview-card card">
      <div class="section">
        ...
        <div class="resource-btns">
          <button type="button" class="secondary" id="previewReload">Reload</button>
          <button type="button" class="secondary" id="previewFullscreen">Full screen</button>
        </div>
      </div>
      <div class="preview-shell" id="previewShell">
        <iframe id="previewFrame" title="Live site preview"></iframe>
        <div class="preview-note" id="previewNote">Start the engine to load a live snapshot here.</div>
      </div>
    </div>
    ...
    <div class="footer">
      This crawls discoverable same-origin resources only. It will not reveal private server files, login-protected routes, or assets never linked from the site. The live preview is a replay snapshot with click and navigation tracking, not a browser security bypass.
    </div>
  </div>
